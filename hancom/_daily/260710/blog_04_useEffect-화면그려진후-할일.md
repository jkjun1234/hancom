...
<img src="images/blog_04_clock_01.png" width="280" alt="Clock 컴포넌트가 현재 시각을 표시하는 화면">
...
| 어느 순간 | 2초 뒤 |
|:---:|:---:|
| <img src="images/blog_04_clock_01.png" width="220" alt="9:13:37"> | <img src="images/blog_04_clock_02.png" width="220" alt="9:13:39"> |

두 장을 잠깐 사이로 찍어봤는데 `37초 → 39초`로 시각이 실제로 흐르고 있다. `setInterval`이 1초마다 `setTime`을 부르고, 그때마다 리렌더돼서 숫자가 바뀌는 것.
...
다음 일정은 **월요일 리액트 미니 프로젝트, 화요일 Node/Express**로 넘어간다. 오늘 배운 fetch·useState·useEffect가 미니 프로젝트에서 바로 쓰일 것 같아서, Header 로그인 토글 숙제부터 마저 끝내놔야겠다.
