...
![flex 적용 전 — 홈/소개/연락이 세로로 쌓인 목록](C:/Users/jun/Desktop/블로그 업로드용 이미지/03_flex-01-before.png)
...
![flex 적용 후 — 홈/소개/연락이 가로로 나란히 놓인 메뉴](C:/Users/jun/Desktop/블로그 업로드용 이미지/03_flex-02-after.png)
